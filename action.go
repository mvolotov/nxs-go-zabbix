...
//
// see: https://www.zabbix.com/documentation/6.0/manual/api/reference/action/object#action-operation
...
//
// see: https://www.zabbix.com/documentation/6.0/manual/api/reference/action/object#action-operation-command
...
//
// see: https://www.zabbix.com/documentation/6.0/manual/api/reference/action/object#action-operation-message
...
//
// see: https://www.zabbix.com/documentation/6.0/manual/api/reference/action/object#action-operation-condition
...
//
// see: https://www.zabbix.com/documentation/6.0/manual/api/reference/action/object#action-recovery-operation
...
//
// see: https://www.zabbix.com/documentation/6.0/manual/api/reference/action/object#action-update-operation
...
//
// see: https://www.zabbix.com/documentation/6.0/manual/api/reference/action/object#action-filter
...
//
// see: https://www.zabbix.com/documentation/6.0/manual/api/reference/action/object#action-filter-condition
...
func (z *Context) ActionCreate(params []ActionObject) ([]string, int, error) {
...
func (z *Context) ActionDelete(actionIDs []string) ([]string, int, error) {
